...
String Sheets_GAS_ID = "AKfycbwnlAaOgtRtVA_mGXerIkvypEGopkzFtI6niTnUQQ8JRcLxx2V0oLT-zd0xYB7BDUzTLw";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() Q
{
  ...
  WIFI_Connect("Chocobo","blackbobo123");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
